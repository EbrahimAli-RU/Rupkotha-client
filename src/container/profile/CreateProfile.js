...
const CreateProfile = (props) => {
    ...
    if(profileState.child.photo === '') {props.history.push('/profile/new')}
    const handler = (id) => {}
    const continueHandler = () => {
        if(profileState.child.name.length !==0 || profileState.child.age.length !==0||profileState.child.language.length !==0) {
        ...
        <Navigation />
         <div className='create__profile__wrapper'>
            <div className='create__profile__content'>
                ...
                <Profile profile={profileState.child.photo} isDisplay={false} handler={handler} />
                <AuthInput 
                    placeholder='Name' 
                    name='name' 
                    type='text' 
                ...
                <Button 
                    ...
                    isDisable={
                        ...
                        profileState.child.language.length===0 ? true: false}  />
